-- Assign All Existing Data to "Domestic" Team
-- Run this SQL in your Supabase SQL Editor
-- This will update all existing records with NULL team_id to the "Domestic" team
...
BEGIN
  ...
  -- Step 2: Update all tables with NULL team_id to Domestic team_id
  -- Employees
  UPDATE employees
  ...
  RAISE NOTICE '✅ All existing data has been assigned to "Domestic" team (ID: %)', domestic_team_id;
END $$;
