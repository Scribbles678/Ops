          ...
          <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            <div class="flex items-center">
              ...
              <p class="text-sm text-yellow-800">
                <strong>Retention Policy:</strong> Schedules older than 1 month are deleted from the main table.
              </p>
            </div>
          </div>
...
const runManualCleanup = async () => {
  if (!confirm('Are you sure you want to run cleanup now? This will archive schedules older than 1 month.')) {
    return
  }
