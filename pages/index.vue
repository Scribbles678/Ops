<template>
  <div class="min-h-screen flex flex-col relative overflow-x-hidden overflow-y-auto bg-gray-50">
    <!-- Logout Button -->
    ...
    <div class="container mx-auto px-4 py-8 sm:py-10 flex-1 flex flex-col items-center justify-start">
      ...
      <div class="max-w-3xl w-full mx-auto grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
        ...
        >
          <div class="flex flex-col items-center justify-center">
            ...
            <h2 class="text-sm md:text-base font-bold text-gray-800 mb-1 text-center">View/Edit Schedule</h2>
            <p class="text-xs text-gray-600 text-center px-2 leading-tight">
        ...
        >
          <div class="flex flex-col items-center justify-center">
            ...
            <h2 class="text-sm md:text-base font-bold text-gray-800 mb-1 text-center">Create Schedule</h2>
            <p class="text-xs text-gray-600 text-center px-2 leading-tight">
      ...
      <div class="text-center mt-6">
        <NuxtLink
          to="/settings"
          class="inline-flex items-center px-6 py-3 border border-gray-300 rounded-lg text-gray-700 bg-white hover:bg-gray-50 transition mr-4"
        >
