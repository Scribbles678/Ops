...
('Locus', '#FFFFFF', 220, 'cartons/hour', 23),
('Helpdesk', '#FFD700', NULL, NULL, 24),
('Coordinator', '#C0C0C0', NULL, NULL, 25),
('Team Lead', '#000080', NULL, NULL, 26),
('Validated', '#FF0000', NULL, NULL, 27),
('Freight', '#800080', NULL, NULL, 28);
